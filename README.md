...
## Role packs (job-specific overlays)

This repo is intentionally **generic** so it can be evaluated across industries. For role-specific context, see:

- `role-packs/TLDR.md` — Skills library + n8n agents across HubSpot, Google Drive, Slack, Sponsy
- `role-packs/MurphyDoor.md` — Internal AI sandbox across sales, engineering, manufacturing, and support

These are short, skimmable 1-pagers that map the same execution layer to a specific environment.
---
